<div class="sidebar-menu">
    ...
    <ul id="main-menu" class="">
        ...
        if ($page_name == 'student_add' ||
				...
				$page_name == 'student_tabulation_sheet')
        ...
        ?> ">
            ...
            <ul>
				...
				<!-- STUDENT Tabulation Sheet -->
				          <li class="<?php if ($page_name == 'student_tabulation_sheet') echo 'opened active'; ?> ">
                    <a href="#">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('student_tabulation_sheet'); ?></span>
                    </a>
                    <ul>
                        <?php
                        $classes = $this->db->get('class')->result_array();
                        foreach ($classes as $row):
                            ?>
                            <li class="<?php if ($page_name == 'student_tabulation_sheet' && $class_id == $row['class_id']) echo 'active'; ?>">
                                <a target="_blank" href="<?php echo base_url(); ?>index.php?admin/student_tabulation_sheet/<?php echo $row['class_id']; ?>">
                                    <span><?php echo get_phrase('class'); ?> <?php echo $row['name']; ?></span>
                                </a>
                            </li>
                        <?php endforeach; ?>
