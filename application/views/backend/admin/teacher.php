            <a href="javascript:;" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_teacher_add/');" 
               ...
               <table class="table table-bordered datatable" id="table_export">
                    <thead>
                        <tr>
                            <th><div><?php echo get_phrase('SL');?></div></th>
                            <th width="80"><div><?php echo get_phrase('Photo');?></div></th>
                            <th><div><?php echo get_phrase('Name');?></div></th>
                            <th><div><?php echo get_phrase('Designation');?></div></th>
                            <th><div><?php echo get_phrase('Index No');?></div></th>
                            <th><div><?php echo get_phrase('Educational Qualification');?></div></th>
