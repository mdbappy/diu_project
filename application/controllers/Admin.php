...
class Admin extends CI_Controller
{
	...
	function student_tabulation_sheet($class_id,$exam_id=1,$section_id="")
	{
		...
		$this->load->view('backend/'.$account_type.'/tabulation_sheet',$page_data);
	}
    ...
    function marks($exam_id = '', $class_id = '', $subject_id = '')
    {
        ...
        if ($this->input->post('operation') == 'update') {
			...
			for($counter = 0; $counter <= count($_POST["mark_obtained"])-1; $counter++)
			{	
				$data['mark_obtained'] = $this->security->xss_clean($_POST['mark_obtained'][$counter]);
	            $data['comment']       = $this->security->xss_clean($_POST['comment'][$counter]);
				
	            $this->db->where('mark_id', $this->security->xss_clean($_POST['mark_id'][$counter]));
